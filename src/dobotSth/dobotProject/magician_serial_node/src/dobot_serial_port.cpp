#include <dobot_serial_port/dobot_serial_port.h>
...
{
    cout << "SerialPort runMain function STARTED!" << endl;
    state_ = WAITING_H1;
    current_header_.resize(2, 0);
    startOneRead();
