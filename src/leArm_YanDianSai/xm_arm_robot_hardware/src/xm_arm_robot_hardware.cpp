...
//设置关键和电机的名称
    jnt_name_.push_back("gripper_1");
    jnt_name_.push_back("joint_2");
    jnt_name_.push_back("joint_3");
    jnt_name_.push_back("joint_4");
    jnt_name_.push_back("joint_5");
    jnt_name_.push_back("joint_6");
